...
<div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xl-3">
            <b-card no-body :img-src="require('~/assets/images/small/img-2.jpg')" img-alt="Card image" img-top>
                <b-card-body>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <b-card header="Featured" footer="2 days ago">
                <b-card-text>
                    <p class="card-text">
                        With supporting text below as a natural lead-in to additional content. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    </p>
                </b-card-text>
            </b-card>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <b-card :img-src="require('~/assets/images/small/img-6.jpg')" img-alt="Card image" img-bottom>
                <b-card-title>
                    <h5 class="card-title">Card title</h5>
                </b-card-title>
                <b-card-text>
        ...
        <div class="col-md-4">
            <b-card overlay :img-src="require('~/assets/images/small/img-7.jpg')" img-alt="Card Image" text-variant="white">
                <b-card-title>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <b-card-group>
                ...
                <b-card :img-src="require('~/assets/images/small/img-2.jpg')" img-alt="Card image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <b-card-group deck>
                <b-card :img-src="require('~/assets/images/small/img-4.jpg')" img-alt="Card image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
                ...
                <b-card :img-src="require('~/assets/images/small/img-6.jpg')" img-alt="Card image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <b-card-group columns>
                <b-card :img-src="require('~/assets/images/small/img-7.jpg')" img-alt="Image" img-top>
                    <b-card-title>
                ...
                <b-card :img-src="require('~/assets/images/small/img-1.jpg')" img-alt="Image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                ...
                <b-card :img-src="require('~/assets/images/small/img-2.jpg')" img-alt="Image" overlay></b-card>
                ...
                <b-card>
                    ...
                    <b-card-text>This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</b-card-text>
                    <b-card-text class="small text-muted">Last updated 3 mins ago</b-card-text>
                </b-card>
            </b-card-group>
        </div>
