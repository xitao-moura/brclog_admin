        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="sub-header">Traditional heading elements are designed to work best in the meat of your page content. When you need a heading to stand out, consider using a display heading—a larger, slightly more opinionated heading style.</p>

                    <h1 class="display-1">Display 1</h1>
                    <p class="text-muted">
                        Suspendisse vel quam malesuada, aliquet sem sit
                        ...
                        hendrerit
                        est consequat posuere et at velit.
                    </p>
                    ...
                    <p class="text-muted">
                        In nec rhoncus eros. Vestibulum eu mattis nisl.
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        Donec ultricies, lacus id tempor condimentum, orci
                        leo faucibus sem, a
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-6 mt-3 mt-xl-0">
                            ...
                            <p class="text-custom">Etiam porta sem malesuada magna mollis euismod.</p>
                            <p class="text-pink">Donec ullamcorper nulla non metus auctor fringilla.</p>
                            ...
                            <p class="text-purple m-b-0">Fusce dapibus, tellus ac cursus commodo, tortor mauris nibh.</p>
                        </div>
                        <!-- end col -->
                    </div>
                    <!-- end row -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <p class="sub-header">A list of items in which the order does not explicitly matter.</p>
                        ...
                        <div class="col-xl-4 mt-3 mt-xl-0">
                            ...
                            <p class="sub-header">A list of items in which the order does explicitly matter.</p>
                        ...
                        <div class="col-xl-4 mt-3 mt-xl-0">
                            ...
                            <p class="sub-header">
                                <strong>
                                    This only applies to immediate children
                                    list items
                                </strong>, meaning you will need to add the class for any nested lists as well.
                            </p>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <p class="text-muted m-b-15 m-t-20">Use text utilities as needed to change the alignment of your blockquote.</p>
