        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">Here it is in blue, along with the supported variants.</p>
                    ...
                    <b-spinner type="grow" class="m-2" variant="light" role="status"></b-spinner>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <b-spinner variant="primary" style="width: 4.5rem; height: 4.5rem;" label="Large Spinner"></b-spinner>
                            <b-spinner style="width: 4.5rem; height: 4.5rem;" label="Large Spinner" type="grow"></b-spinner>
                        </div>
                        <!-- end col -->

                        <div class="col-lg-6">
                            <b-spinner variant="primary" style="width: 3.5rem; height: 3.5rem;" label="Large Spinner"></b-spinner>
                            <b-spinner style="width: 3.5rem; height: 3.5rem;" label="Large Spinner" type="grow"></b-spinner>
                        </div>
                        <!-- end col -->

                        <div class="col-lg-6">
                            <b-spinner variant="primary" style="width: 2.25rem; height: 2.25rem;" class="ml-1 mt-3" label="Large Spinner"></b-spinner>
                            <b-spinner style="width: 2.25rem; height: 2.25rem;" class="ml-3 mt-3" label="Large Spinner" type="grow"></b-spinner>
                        </div>
                        <!-- end col -->

                        <div class="col-lg-6">
                            <b-spinner small label="Small Spinner" class="mt-3"></b-spinner>
                            <b-spinner small label="Small Spinner" class="ml-2" type="grow"></b-spinner>
                        </div>
                        <!-- end col -->
                    </div>
                    <!--end row-->
