        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="sub-header">Example of image popup.</p>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="sub-header">Show caption with popup.</p>
                    <div class="popup-gallery">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <a class="popup-form btn btn-primary" href="javascript: void(0);" v-b-modal.modal-1>Popup form</a>
