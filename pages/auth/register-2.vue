...
export default {
    head() {
        return {
            title: `Register 2 | Minton - Nuxtjs Responsive Admin Dashboard Template`,
        };
    },
    data() {
        return {};
...
<div>
    ...
    <footer class="footer footer-alt">
        <p class="text-muted">
            ...
            <nuxt-link to="/auth/login-2" class="text-primary font-weight-medium ml-1">Sign In</nuxt-link>
        </p>
    </footer>
</div>
</template>
