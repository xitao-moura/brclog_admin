        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14 m-b-20">Parsley is a javascript form validation library. It helps you provide your users with feedback on their form submission before sending it to your server.</p>
                    ...
                    <form @submit.prevent="handleSubmit">
                        <div class="form-group">
                            ...
                            <input id="username" v-model="form.name" name="username" class="form-control" :class="{ 'is-invalid': submitted && $v.form.name.$error }" type="text" placeholder="Enter user name" />
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.email" type="email" name="email" class="form-control" :class="{ 'is-invalid': submitted && $v.form.email.$error }" placeholder="Enter email" />
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.password" type="password" name="password" class="form-control" :class="{ 'is-invalid': submitted && $v.form.password.$error }" placeholder="Password" />
                        ...
                        <div class="form-group">
                            ...
                            <input id="passWord2" v-model="form.confirmPassword" type="password" name="confirmPassword" class="form-control" :class="{ 'is-invalid': submitted && $v.form.confirmPassword.$error }" placeholder="Password" />
                            <div v-if="submitted && $v.form.confirmPassword.$error" class="invalid-feedback">
                                <span v-if="!$v.form.confirmPassword.required">This value is required.</span>
                                <span v-else-if="!$v.form.confirmPassword.sameAsPassword">This value should be the same.</span>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="horizontalForm">
                        <div class="form-group row">
                            ...
                            <div class="col-7">
                                <input v-model="horizontal.email" type="email" name="email" class="form-control" :class="{ 'is-invalid': formsubmit && $v.horizontal.email.$error }" placeholder="Enter email" />
                                <div v-if="formsubmit && $v.horizontal.email.$error" class="invalid-feedback">
                                    <span v-if="!$v.horizontal.email.required">This value is required.</span>
                                    <span v-if="!$v.horizontal.email.email">This value should be a valid email.</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-7">
                                <input v-model="horizontal.password" type="password" name="password" class="form-control" :class="{ 'is-invalid': formsubmit && $v.horizontal.password.$error }" placeholder="Password" />
                                <div v-if="formsubmit && $v.horizontal.password.$error" class="invalid-feedback">
                                    <span v-if="!$v.horizontal.password.required">This value is required.</span>
                                    <span v-if="!$v.horizontal.password.minLength">Password must be at least 6 characters.</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-7">
                                <input v-model="horizontal.confirmPassword" type="password" name="confirmPassword" class="form-control" :class="{ 'is-invalid': formsubmit && $v.horizontal.confirmPassword.$error }" placeholder="Password" />
                                <div v-if="formsubmit && $v.horizontal.confirmPassword.$error" class="invalid-feedback">
                                    <span v-if="!$v.horizontal.confirmPassword.required">This value is required.</span>
                                    <span v-else-if="!$v.horizontal.confirmPassword.sameAsPassword">This value should be the same.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-7">
                                <input id="website" v-model="horizontal.website" type="text" name="website" class="form-control" :class="{ 'is-invalid': formsubmit && $v.horizontal.website.$error }" placeholder="URL" />
                                <div v-if="formsubmit && $v.horizontal.website.$error" class="invalid-feedback">
                                    <span v-if="!$v.horizontal.website.required">This value is required.</span>
                                    <span v-if="!$v.horizontal.website.url">This value should be a valid url.</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card-body">
                    ...
                    <form action="#" @submit.prevent="typeForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                <input v-model="typeform.confirmPassword" type="password" name="confirmPassword" class="form-control" :class="{ 'is-invalid': typesubmit && $v.typeform.confirmPassword.$error }" placeholder="Password" />
                        ...
                        <div class="form-group">
                            <label>E-Mail</label>
                            <div>
                                <input v-model="typeform.email" type="email" name="email" class="form-control" :class="{ 'is-invalid': typesubmit && $v.typeform.email.$error }" placeholder="Enter a valid email" />
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea v-model="typeform.textarea" class="form-control" name="textarea" :class="{ 'is-invalid': typesubmit && $v.typeform.textarea.$error }"></textarea>
