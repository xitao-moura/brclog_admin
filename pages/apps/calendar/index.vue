...
<div>
    ...
    <b-modal v-model="showModal" title="Add New Event" title-tag="h5" body-class="px-4 pb-4 pt-0" header-class="text-black font-18 border-bottom-0 py-3 px-4" hide-footer>
    ...
    <!-- Edit Modal -->
    <b-modal v-model="eventModal" title="Edit Event" title-tag="h5" body-class="px-4 pb-4 pt-0" header-class="text-black font-18 border-bottom-0 py-3 px-4" hide-footer>
