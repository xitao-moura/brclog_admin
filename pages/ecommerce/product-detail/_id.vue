                                    ...
                                    <div id="product-carousel" class="carousel slide product-detail-carousel" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div>
                                                    <img src="~/assets/images/products/product-6.png" alt="product-img" id="myImage" class="img-fluid" />
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>
                                                    <img src="~/assets/images/products/product-8.png" alt="product-img" class="img-fluid" />
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>
                                                    <img src="~/assets/images/products/product-1.png" alt="product-img" class="img-fluid" />
                                                </div>
                                            </div>
                                        </div>
                                        <ol class="carousel-indicators product-carousel-indicators mt-2">
                                            <li data-target="#product-carousel" data-slide-to="0" class="active">
                                                <img src="~/assets/images/products/product-6.png" @click="changeImage($event)" alt="product-img" class="img-fluid product-nav-img" />
                                            </li>
                                            <li data-target="#product-carousel" data-slide-to="1">
                                                <img src="~/assets/images/products/product-8.png" @click="changeImage($event)" alt="product-img" class="img-fluid product-nav-img" />
                                            </li>
                                            <li data-target="#product-carousel" data-slide-to="2">
                                                <img src="~/assets/images/products/product-1.png" @click="changeImage($event)" alt="product-img" class="img-fluid product-nav-img" />
                                            </li>
                                        </ol>
                                    </div>
                                </div>
