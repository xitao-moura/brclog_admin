                                ...
                                <tab-content title="Billing Info">
                                    ...
                                    <ul class="pager wizard list-inline mt-2">
                                        <li class="list-inline-item">
                                            <nuxt-link to="/ecommerce/cart" class="btn btn-secondary"><i class="mdi mdi-arrow-left"></i> Back to Shopping
                                                Cart
                                            </nuxt-link>
                                        </li>
                                        <li class="next list-inline-item float-right">
                                            <button type="button" class="btn btn-success">
                                                <i class="mdi mdi-truck-fast mr-1"></i> Proceed to
                                                Shipping
                                            </button>
                                        </li>
                                    </ul>
                                </tab-content>
                                <tab-content title="Shipping Info">
                                    <div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="border p-3 rounded mb-3 mb-md-0">
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        ...
                                                        <label class="custom-control-label font-16" for="customRadio1">Home</label>
                                                    </div>
                                                    ...
                                                    <p class="mb-0">
                                                        <span class="font-weight-semibold mr-2">Mobile:</span>
                                                        (+01) 12345 67890
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="border p-3 rounded mb-3 mb-md-0">
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        ...
                                                        <label class="custom-control-label font-16" for="customRadio2">Office</label>
                                                    </div>
                                                    <div class="float-right">
                                                        <a href="#"><i class="mdi mdi-square-edit-outline text-muted font-20"></i></a>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="border p-3 rounded mb-3">
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label font-16" for="shippingMethodRadio1">Standard Delivery - FREE</label>
                                                    </div>
                                                    <p class="mb-0 pl-3 pt-1">
                                                ...
                                                <div class="border p-3 rounded">
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label font-16" for="shippingMethodRadio2">Fast Delivery - $25</label>
                                                    </div>
                                                    <p class="mb-0 pl-3 pt-1">
                                    ...
                                    <div>
                                        ...
                                        <div class="border p-3 mb-3 rounded">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                ...
                                                <label class="custom-control-label font-16" for="BillingOptRadio2">Pay with Paypal</label>
                                            </div>
                                            <p class="mb-0 pl-3 pt-1">
                                        ...
                                        <div class="border p-3 mb-3 rounded">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                ...
                                                <label class="custom-control-label font-16" for="BillingOptRadio1">Credit / Debit Card</label>
                                            </div>
                                            <p class="mb-0 pl-3 pt-1">
                                        ...
                                        <div class="border p-3 mb-3 rounded">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                ...
                                                <label class="custom-control-label font-16" for="BillingOptRadio4">Cash on Delivery</label>
                                            </div>
                                            <p class="mb-0 pl-3 pt-1">
                                        ...
                                        <table class="table table-centered table-nowrap mb-0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <nuxt-link to="/ecommerce/product-detail/1" class="text-body font-weight-semibold">Blue color T-shirt</nuxt-link>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <nuxt-link to="/ecommerce/product-detail/1" class="text-body font-weight-semibold">Blue Hoodie for men</nuxt-link>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="~/assets/images/products/product-8.png" alt="product-img" title="product-img" class="rounded mr-2" height="48" />
                                                    </td>
                                                    <td>
                                                        <nuxt-link to="/ecommerce/product-detail/1" class="text-body font-weight-semibold">Full sleeve Pink T-shirt</nuxt-link>
