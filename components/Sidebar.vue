...
<div class="left-side-menu">
    ...
    <div class="logo-box">
        <nuxt-link to="/" class="logo logo-dark text-center">
            <span class="logo-sm">
                <img src="~/assets/images/logo-brc.png" alt height="20" />
                <!-- <span class="logo-lg-text-light">Minton</span> -->
            </span>
            <span class="logo-lg">
                <img src="~/assets/images/logo-brc.png" alt height="50" />
    ...
    <simplebar class="h-100" data-simplebar>
        ...
        <div class="user-box text-center">
            ...
            <div class="dropdown">
                <a href="javascript: void(0);" class="text-reset dropdown-toggle h5 mt-2 mb-1 d-block" data-toggle="dropdown">Xitão</a>
